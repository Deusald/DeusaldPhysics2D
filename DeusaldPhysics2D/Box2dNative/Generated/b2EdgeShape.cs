...
internal class b2EdgeShape : b2Shape {
  ...
  public void SetOneSided(b2Vec2 v0, b2Vec2 v1, b2Vec2 v2, b2Vec2 v3) {
    Box2dPINVOKE.b2EdgeShape_SetOneSided(swigCPtr, b2Vec2.getCPtr(v0), b2Vec2.getCPtr(v1), b2Vec2.getCPtr(v2), b2Vec2.getCPtr(v3));
    if (Box2dPINVOKE.SWIGPendingException.Pending) throw Box2dPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetTwoSided(b2Vec2 v1, b2Vec2 v2) {
    Box2dPINVOKE.b2EdgeShape_SetTwoSided(swigCPtr, b2Vec2.getCPtr(v1), b2Vec2.getCPtr(v2));
    if (Box2dPINVOKE.SWIGPendingException.Pending) throw Box2dPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public bool m_oneSided {
    set {
      Box2dPINVOKE.b2EdgeShape_m_oneSided_set(swigCPtr, value);
    } 
    get {
      bool ret = Box2dPINVOKE.b2EdgeShape_m_oneSided_get(swigCPtr);
      return ret;
    } 
  }
