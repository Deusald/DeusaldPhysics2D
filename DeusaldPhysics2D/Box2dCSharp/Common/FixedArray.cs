...
{
    internal static class FixedArrayExtensions
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ref T GetRef<T>(ref this FixedArray2<T> array, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ref T GetRef<T>(ref this FixedArray3<T> array, int index)
            where T : unmanaged
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static ref T GetRef<T>(ref this FixedArray8<T> array, int index)
            where T : unmanaged
        {
            switch (index)
            {
