...
{
    internal interface IQueryCallback
    {
        bool QueryCallback(Fixture fixture);
    }

    internal interface IRayCastCallback
    {
...
{
    internal interface ITreeQueryCallback
    {
        bool QueryCallback(int proxyId);
    }

    internal interface ITreeRayCastCallback
    {
        float RayCastCallback(in RayCastInput input, int proxyId);
    }

    internal interface IAddPairCallback
    {
