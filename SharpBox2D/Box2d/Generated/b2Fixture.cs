...
internal class b2Fixture : global::System.IDisposable {
  ...
  public b2FixtureUserData GetUserData() {
    b2FixtureUserData ret = new b2FixtureUserData(Box2dPINVOKE.b2Fixture_GetUserData(swigCPtr), false);
    return ret;
  }
  ...
  public float GetRestitutionThreshold() {
    float ret = Box2dPINVOKE.b2Fixture_GetRestitutionThreshold(swigCPtr);
    return ret;
  }

  public void SetRestitutionThreshold(float threshold) {
    Box2dPINVOKE.b2Fixture_SetRestitutionThreshold(swigCPtr, threshold);
  }
