...
internal class b2JointDef : global::System.IDisposable {
  ...
  public b2JointUserData userData {
    set {
      Box2dPINVOKE.b2JointDef_userData_set(swigCPtr, b2JointUserData.getCPtr(value));
    } 
    get {
      global::System.IntPtr cPtr = Box2dPINVOKE.b2JointDef_userData_get(swigCPtr);
      b2JointUserData ret = (cPtr == global::System.IntPtr.Zero) ? null : new b2JointUserData(cPtr, false);
      return ret;
    } 
  }
